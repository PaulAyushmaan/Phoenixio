...
interface PublicCourseBrowserProps {
  onViewCourse: (courseId: string) => void;
  onLogin: () => void;
}

const PublicCourseBrowser: React.FC<PublicCourseBrowserProps> = ({ onViewCourse, onLogin }) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover world-class courses with AI-generated highlights that help you learn faster
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-16 bg-gradient-to-r from-primary-500 to-accent-500 rounded-2xl p-8 text-white text-center">
          ...
          <p className="text-lg mb-6 opacity-90">
            Join thousands of students who are already transforming their learning with AI-powered highlights
          </p>
          <button
            onClick={onLogin}
...
export default PublicCourseBrowser;